...
toolchain-smoke-quarto:
	$(QUARTO) render reports/quarto_toolchain_smoke_test.qmd --to html
...
render-report-html:
	$(RSCRIPT) -e "rmarkdown::render('reports/assessment_modeling_report.Rmd', output_format='html_document')"

render-report-pdf:
	$(RSCRIPT) -e "rmarkdown::render('reports/assessment_modeling_report.Rmd', output_format='pdf_document')"

render-gradebook-report-html:
	$(RSCRIPT) -e "rmarkdown::render('reports/gradebook_synthesis_report.Rmd', output_format='html_document')"

render-gradebook-report-pdf:
	$(RSCRIPT) -e "rmarkdown::render('reports/gradebook_synthesis_report.Rmd', output_format='pdf_document')"
